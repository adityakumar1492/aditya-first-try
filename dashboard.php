...
<head>
    ...
    <title>To kaise hai aaplog</title>
    <style>
        .end {
...
<body>
    <div class="content">
        <div class="container-fluid">
            <!-- <div class="row">
                <div class="col-2">
                    <img src="logo/sun.jpg" alt="" width="100%">
                </div>
                <div class="col-7 mt-4">
                    <div class="row">
                        <div class="col-3"></div>
                        <div class="col-6 text-end mt-3">
                            <input type="search" placeholder="search..." name="search" class="rounded-pill form-control">
                        </div>
                        <div class="col-3 mt-3">
                            <button type="submit" name="search" class="btn btn-danger rounded-pill text-start"><i class="fa fa-search"></i></button>
                        </div>
                    </div>
                </div>
                <div class="col-3 mt-5 text-center">
                    <i class="fa fa-facebook circle end"></i>
                    <i class="fa fa-instagram circle end "></i>
                    <i class="fa fa-whatsapp circle end"></i>
                    <i class="fa fa-youtube circle end"></i>
                </div>
            </div>
            ...
            <header class='c-header'>
                <h1 class='c-header__title text-white'>Blue Planet</h1>
                ...
                <div class='c-cta'>
                    ...
                    <button class='c-cta__button c-cta__button__search'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56.966 56.966">
            ...
            <div class='c-socials'>
                <ul class='c-socials__list'>
                    <li class='c-socials__list-item'><a href='' title=''><svg height="512" viewBox="0 0 24 24" width="512" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class='c-socials__list-item'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <li class='c-socials__list-item'><a href='' title=''><svg height="512pt" viewBox="0 0 512 512.00006" width="512pt" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class='c-slide' style='background-image:url("https://images.unsplash.com/photo-1504461407194-07c608d0989b?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1900&q=100")'>
                        <div class='c-slide-content'>
                            <div class='c-wrap c-wrap--line'>
                                <h2 class='c-slide__title text-white'>
                                    Underwater
                                    <span class='c-slide__title--large text-white'>Monsters</span>
                                </h2>
                            </div>
                            <div class='c-wrap c-wrap--small'>
                                <div class='c-slide__info'>
                                    <h3 class='c-slide__subtitle text-white'>Saltwater Crocodile</h3>
                                    <p class='c-slide__body text-white'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class='c-slide' style='background-image:url("https://images.unsplash.com/photo-1544745494-3d8dd3fa1564?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1900&q=100")'>
                        <div class='c-slide-content'>
                            <div class='c-wrap c-wrap--line'>
                                <h2 class='c-slide__title text-white'>
                                    The
                                    <span class='c-slide__title--medium text-white'>Gates of Hell</span>
                                </h2>
                            </div>
                            <div class='c-wrap c-wrap--small'>
                                <div class='c-slide__info'>
                                    <h3 class='c-slide__subtitle text-white'>Special inside volcanoes</h3>
                                    <p class='c-slide__body text-white'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class='c-slide' style='background-image:url("https://images.unsplash.com/photo-1528214096798-37891d32174c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1900&q=100")'>
                        <div class='c-slide-content'>
                            <div class='c-wrap c-wrap--line'>
                                <h2 class='c-slide__title text-white'>
                                    Exploring
                                    <span class='c-slide__title--large text-white'>Deep Caves</span>
                                </h2>
                            </div>
                            <div class='c-wrap c-wrap--small'>
                                <div class='c-slide__info'>
                                    <h3 class='c-slide__subtitle text-white'>Real Time Capsules</h3>
                                    <p class='c-slide__body text-white'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                    </p>
                                </div>
                            </div>
    ...
    <div class="row">
        <div class="col-4">
            <div class="card">
                 <img src="image/peacock.jpeg" alt="">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque sed aperiam vitae repellat, eum recusandae blanditiis quibusdam aspernatur inventore laborum obcaecati accusantium, enim ullam porro a ratione tempore deserunt iste?
                Libero cum sint officiis facere amet et consequuntur fugit dolorem ut mollitia repellendus explicabo ab, ipsa eius dignissimos, omnis culpa nemo molestiae quae reprehenderit minus harum pariatur ex? Saepe, sint.
            </div>
        </div>
        <div class="col-4"></div>
        <div class="col-4"></div>
